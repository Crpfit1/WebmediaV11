  ...
  const teamMembers = [
    {
     name: "Ayémou Essoubo Loïc-Yvan",
      ...
      social: {
        ...
        linkedin: "https://www.linkedin.com/in/loïc-yvan-ayémou225",
    ...
    },
    {
      ...
      achievements: [
        ...
        "Co-founder de Bit Trading Éducation, un centre de formation",
